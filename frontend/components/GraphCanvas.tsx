...
import GoldLoader from "./ui/GoldLoader";
  ...
  return (
    <section className="glass relative flex flex-col p-5">
      <div className="mb-3 flex flex-wrap items-center gap-3">
        <h2 className="font-grotesk text-sm font-semibold tracking-widest text-text-muted">MULE-RING GRAPH CANVAS</h2>
        {data && (
          <>
      ...
      <div className="relative overflow-hidden rounded-md border border-border bg-bg-primary/40">
        {error ? (
          ...
          <div className="relative h-[420px]"><GoldLoader center label="loading topology…" /></div>
        ) : !layout ? (
      ...
      <div className="mt-3 flex flex-wrap gap-x-4 gap-y-1.5">
        ...
        <span className="flex items-center gap-1.5 font-mono text-[9.5px] text-danger">
          <span className="h-2 w-2 rounded-full bg-danger shadow-neon" />FLAGGED MULE
        </span>
      </div>
    </section>
  );
